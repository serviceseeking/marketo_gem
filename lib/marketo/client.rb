...
module Rapleaf
  module Marketo
    ...
    def self.new_client(access_key, secret_key, api_subdomain = 'na-i', api_version = '1_5', document_version = '1_4')
      client = Savon::Client.new(log: false, endpoint: "https://#{api_subdomain}.mktoapi.com/soap/mktows/#{api_version}", wsdl: "http://app.marketo.com/soap/mktows/#{document_version}?WSDL") do
